...
-- ===== ALO1234VC KEY SYSTEM =====
do
    local REQUIRED_KEY = "alo1234vc"
    ...
    button.Position = UDim2.new(0, 20, 0, 108)
...
local v466 = vu32:MakeWindow({
    Title = "alo1234vc : Blox Fruits",
    SubTitle = "alo1234vc",
    SaveFolder = "alo1234vc"
})
